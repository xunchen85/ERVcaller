...
#
# Updates (v0.1.3):
#       11/20/2018:             Add the scripts to merge various samples into a list of known TE loci or TE loci detected from the analyzed samples;
# 	11/12/2018:		Update the Output in VCFv4.2 format;
# 	11/05/2018:		Debug the support of the BAM files generated using Bowtie2;
#
# Updates (v0.1.2):
#	11/01/2018:		Further optimize the speed of validation steps;
#	10/21/2018:		Support the input of multiple bam file;
#	10/10/2018:		Optimize the validation steps to increase the specificity;
#
# Updates (v0.1.1):
...
#	07/15/2018:         	Released ERVcaller Verson 0.1.1 and software manual
#
# Release (v0.1.0):
#	05/27/2018:         	Released ERVcaller Verson 0.1.0  (a testing version) and software manual
#
# Questions or help:
#
